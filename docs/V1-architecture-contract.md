...
状态：保留 V1-01 至 V1-05 设计基线；2026-09-18 已完成 V1-14 前端接入与 V1-15 验收。真实 LangGraph 业务图已接入；当前恢复点为等待 low / V1-16 确认。
...
- 详细验收见 `V1-14-frontend-acceptance.md`、`V1-15-acceptance.md`。V1 是固定快照、本机单用户、有界确定性业务图；未提供自由问数、多模型推理、自动续跑或生产上线验收。
